...
public class test4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        test_submit = findViewById(R.id.test4_submit);
        test_back = findViewById(R.id.test4_back);
    ...
    private void resultDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                databaseReference.child("Users").child(UserID).child("age").setValue(skinResult);
        ...
        if (sum > 50) {
            skinResult = "Firming";
            result.setText("Your skin is Firming");
            linearLayout.setPadding(10,10,10,10);
