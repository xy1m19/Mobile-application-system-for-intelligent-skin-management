...
public class test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        test_submit = findViewById(R.id.test_submit);
        ...
        test_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (optionID2 == R.id.select1_2_1 || optionID2== R.id.select1_2_2 ) {
                    num2 = 20;
                }else if(optionID2 == R.id.select1_2_3 || optionID2 == R.id.select1_2_4 ){
                    num2 = 0;
                }else{}

                if (optionID3 == R.id.select1_3_1 || optionID3 == R.id.select1_3_2 ) {
                    num3 = 20;
                }else if(optionID3 == R.id.select1_3_3 || optionID3 == R.id.select1_3_4){
                    num3 = 0;

                }else{}

                if (optionID4 == R.id.select1_4_1 || optionID4 == R.id.select1_4_2) {
                    num4 = 20;
                }else if(optionID4 == R.id.select1_4_3 || optionID4 == R.id.select1_4_4){
                    num4 = 0;

                }
                if (optionID5 == R.id.select1_5_1 || optionID5==R.id.select1_5_2 ) {
                    num5 = 20;
                }else if(optionID5 == R.id.select1_5_3 || optionID5 == R.id.select1_5_4 ){
                    num5 = 0;
    ...
    private void resultDialog() {
        ...
        if (sum > 50) {
            skinResult = "oil";
            result.setText("Your skin is oil");
            linearLayout.setPadding(10,10,10,10);
        }else {
            skinResult = "dry";
            result.setText("Your skin is dry");
            linearLayout.setPadding(10, 10, 10, 10);
        }
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                databaseReference.child("Users").child(UserID).child("skin").setValue(skinResult);
