...
public class test3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        test_submit = findViewById(R.id.test3_submit);
        test_back = findViewById(R.id.test3_back);
    ...
    private void resultDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                databaseReference.child("Users").child(UserID).child("pigment").setValue(skinResult);
        ...
        if (sum > 50) {
            skinResult="Non-Pigment";
            result.setText("Your skin is Pigment");
            linearLayout.setPadding(10,10,10,10);
